console.log("CATEGORIAS.JS OK - API + FAMÍLIA + EXCLUÍDOS + EDIÇÕES LOCAIS");
...
async function carregarCategoriasAPIUsuario() {
  ...
  console.log("CATEGORIAS DA API:", categoriasAPIUsuario);
}
...
async function carregarCategorias() {
  ...
  if (usuarioPertenceFamiliaCategorias) {
    ...
    console.log("CATEGORIAS - USUÁRIO TEM FAMÍLIA:", usuarioPertenceFamiliaCategorias);
    console.log("CATEGORIAS - FAMILY ID:", familyId);
    ...
    if (familyId) {
      ...
      console.log("CATEGORIAS - DESPESAS FAMÍLIA:", despesasFamiliaLista);
      console.log("CATEGORIAS - RECEITAS FAMÍLIA:", receitasFamiliaLista);
  ...
  /*
    Sem família: mostra somente dados do usuário logado.
    Com família: mantém dados de todos os membros.
  */
  if (!usuarioPertenceFamiliaCategorias) {
  ...
  /*
    Os endpoints já vieram filtrados por month/year.
    Mesmo assim mantemos o filtro local para segurança.
  */
  ...
  console.log("FAMÍLIA CATEGORIAS:", usuarioPertenceFamiliaCategorias);
  console.log("DESPESAS API USADAS EM CATEGORIAS:", despesasDoMes);
  console.log("RECEITAS API USADAS EM CATEGORIAS:", receitasDoMes);
