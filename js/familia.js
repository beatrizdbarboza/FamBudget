(() => {
  ...
  function limparItensFamiliaDaLista(chave, storage = localStorage) {
    ...
    try {
      ...
      const listaIndividual = lista.filter((item) => !itemPertenceAFamilia(item));
  ...
  async function leaveFamily() {
    showConfirmPopup("Você realmente deseja sair desta família?", async () => {
      ...
      showPopup("Você saiu da família. Os dados compartilhados foram desvinculados desta conta.");
