console.log("RELATORIOS.JS OK - API + FAMÍLIA + EXCLUÍDOS + EDIÇÕES LOCAIS");
...
async function carregarCategoriasRelatoriosAPI() {
  try {
    ...
    console.log("CATEGORIAS RELATÓRIOS API:", categoriasAPIRelatorios);
  } catch (erro) {
...
async function carregarRelatorios() {
  try {
    ...
    console.log("RELATÓRIOS RECEITAS API:", receitas);
    console.log("RELATÓRIOS DESPESAS API:", despesas);
...
async function buscarReceitas() {
  ...
  if (usuarioPertenceFamiliaRelatorios) {
    ...
    console.log("RELATÓRIOS - USUÁRIO TEM FAMÍLIA:", usuarioPertenceFamiliaRelatorios);
    console.log("RELATÓRIOS - FAMILY ID:", familyId);
    ...
    if (familyId) {
      ...
      console.log("RELATÓRIOS - RECEITAS FAMÍLIA:", listaFamilia);
...
async function buscarDespesas() {
  ...
  if (usuarioPertenceFamiliaRelatorios) {
    ...
    if (familyId) {
      ...
      console.log("RELATÓRIOS - DESPESAS FAMÍLIA:", listaFamilia);
